    ...
    <div className="min-h-screen h-full w-full overflow-hidden flex flex-col items-center justify-center bg-brand-background ">
      <div className="relative w-full min-h-screen items-center justify-center">
        ...
        >
          ...
          <div
            className=" px-2 py-6 max-h-auto absolute border top-0 w-screen left-0 right-0 bottom-0 m-auto rounded-xl bg-gray-900/90 space-x-2 "
            style={{ visibility: Auction_Page }}
          >
            <div className="flex aspect-auto min-h-0 min-w-screen justify-center items-center h-auto w-auto  mx-10  ">
              <figure>
              <img
                className=" aspect-square h-[220px] border"
